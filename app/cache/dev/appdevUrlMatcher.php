...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // hide
        if (rtrim($pathinfo, '/') === '/hide') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'hide');
            }
            return array (  '_controller' => 'Acme\\JqueryBundle\\Controller\\DefaultController::hideAction',  '_route' => 'hide',);
        }

        // hide_parent
        if (rtrim($pathinfo, '/') === '/hide_parent') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'hide_parent');
            }
            return array (  '_controller' => 'Acme\\JqueryBundle\\Controller\\DefaultController::hideParentAction',  '_route' => 'hide_parent',);
        }
        ...
        if (rtrim($pathinfo, '/') === '/slide') {
            ...
            return array (  '_controller' => 'Acme\\JqueryBundle\\Controller\\DefaultController::slideAction',  '_route' => 'slide',);
        }

        // fade
        if (rtrim($pathinfo, '/') === '/fade') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'fade');
            }
            return array (  '_controller' => 'Acme\\JqueryBundle\\Controller\\DefaultController::fadeAction',  '_route' => 'fade',);
        }

        // animate
        if (rtrim($pathinfo, '/') === '/animate') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'animate');
            }
